...
import { getLabels, getNumberOfUnlockedExercisesForDiscipline, wordsDescription } from '../../services/helpers'
...
const ExercisesScreen = ({ route, navigation }: ExercisesScreenProps): JSX.Element => {
  ...
  useFocusEffect(
    useCallback(() => {
      getNumberOfUnlockedExercisesForDiscipline(disciplineId)
